...
from bioimage_phenotyping.dataset import Cellprofiler
...
# from cellesce import Cellesce
from bioimage_phenotyping import shapes
...
plt.show()
plt.savefig(metadata("fingerprints_10.pdf"), bbox_inches="tight")
# plt.show();plt.close()
# %%
